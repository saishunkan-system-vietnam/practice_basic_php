...
<div class="sidebar">
    ...
    <div class="home">
            <button class="btnsidebar" type="button" id="btnhome" style="text-align: center;font-weight:bolder">Home</button>
        </div>

        <div class="home">
            <button class="btnsidebar" type="button" id="btnmanage_home">🏠 Manage home</button>
        </div>
