                        ...
                        if (isset($_GET['job']) || isset($_POST['recruitment_id'])) {
                            ...
                            if ($resultData && $resultData->num_rows > 0) {
                                while ($rowData = $resultData->fetch_assoc()) {
                                    ...
                                    echo "<input type='button' data-id = " . $rowData["id"] . " style = 'border: 1px solid green; background:white;padding:5px 10px' class='btnapply'  name =" . $rowData["id"] . " value='Ứng tuyển'></input>";
