...
class OrderController extends AppController
{
    ...
    public function processOdr($id = null, $status = 1)
    {
        if ($this->request->is('post')) 
        {
            $data = ['id'=>$id, 'status'=>(int)$status + 1];
